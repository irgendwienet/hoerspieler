...
// Artist paw patrol
let pawPatrol = "1JPhbKU3boL67fftU3U1ED"
let lausemaus = "6b9DQDp0xKeYM2vdK9pAE6"
spotify.Artists.Get(lausemaus).Result
let page1 = spotify.Artists.GetAlbums(lausemaus).Result
...
for album in all do
    ...
    let episode = nummerRegex.Match(album.Name).Groups.Item(1).Value    
